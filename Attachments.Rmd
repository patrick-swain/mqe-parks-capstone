...
```
```{r}
summary(census_tracts$area)  # Should match real-world tract sizes
summary(intersection$area)    # Should align with parks' sizes
#intersection$area <- intersection$area / 4046.85642  # Convert m² → acres
```
